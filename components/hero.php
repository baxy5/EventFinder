    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-4 mb-lg-0">
                <h1 class="display-3 fw-bold">Mindenkinek, bárhonnan, azonnal <span class="text-primary">WebSzaki</span>
                </h1>
                <p class="lead my-4">Webshoppunkban minden megtalálható, csak válassza ki, rendelje meg, és egy
                    napon
                    házhoz terem terméke.</p>
            </div>
            <div class="col-lg-6"><img alt="" class="img-fluid" src="./img/hero-image.jpg">
            </div>
        </div>
        <div class="row mt-5">
            ...
            <div class="col-md-3 col-sm-6 mb-3 mb-md-0">
                ...
                <h4>Bizalom</h4>
                <p>Ügyfeleink bizalmát elnyertük, gyors és biztos kiszállításunkal</p>
            </div>
            <div class="col-md-3 col-sm-6">
                ...
                <h4>Stratégia</h4>
                <p>Legjobb termékeket szolgáltatjuk, olcsó áron</p>
            </div>
        </div>
    </div>
</section>